...
class PaymentProfile(admin.ModelAdmin):
    search_fields = ('id', 'external_ref', 'channel', 'profile__user__email')
    list_filter = ('enabled', 'channel', 'external_obj')
...
class SubscriptionAdmin(admin.ModelAdmin):
    search_fields = ('id', 'ref', 'external_ref', 'status', 'type', 'item', 'transaction__channel')
...
class TransactionAdmin(admin.ModelAdmin):
    search_fields = ('id', 'ref', 'external_ref', 'quantity', 'unit_price', 'total', 'channel', 'status', 'type', 'currency', 'items')
