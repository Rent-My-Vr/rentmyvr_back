...
class PropertyAdmin(admin.ModelAdmin):
    list_display = ('ref', 'name', 'video', 'virtual_tour', 'type', 'space', 'hosted_by', 'no_of_guest', 'no_of_bedrooms', 'no_of_bathrooms', 'is_pet_allowed', 'suitability', 'price_night', 'address', 'email', 'phone', 'logo', 'facebook', 'instagram', 'tiktok', 'twitter', 'google_business', 'yelp', 'enabled', 'created', 'updated')
